...
public class Gui extends JFrame{
	...
	private ImageIcon icon = new ImageIcon(this.getClass().getResource("img/Image.jpg"));
	...
	public Gui() throws IOException
	{
		...
		for(int z = 0; z<4; z++)
		{
			for(int c = 0; c<4; c++)
			{
				...
				gameGrid[z][c].setFont(new Font("Gill Sans MT", Font.PLAIN, 32));
	...
	public static void setMaxScore(int x) throws IOException
	{
		...
		FileManager.writeData(maxScoreN);
	}
